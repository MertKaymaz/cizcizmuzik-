...
app.get("/", (request, response) => {
  console.log(`CızCızMüzik Botu Acık !`);
...
client.on("voiceStateUpdate", (old, neww) => {
  ...
  if (!neww.voiceChannel) {
    if (neww.id === client.user.id) {
      console.log(`Pluscık: yeniden başlatıldım ve başarılı geçiyor`);
      process.exit(0);
      console.clear();
    }
  }
...
client.on("message", async msg => {
  ...
  if (msg.content.startsWith("!!çal")) {
    console.log("Çal Komutu Çalıştı");
    let mesaj2 =
    ...
    if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlis(.*)$/)) {
      ...
      return msg.channel
        ...
        .setTitle(`**\`${playlist.title}\` adındaki şarkıyı çalıcaklar listesine ekledim ! <a:mk_evet2:780868350975934502> **`);
    } else {
      try {
        ...
        try {
          ...
          msg.channel.sendEmbed(
            new Discord.RichEmbed()
              ...
              .setFooter(
                "**__1__-__10__ arasında bir sayı belirtmelisin. Belirtmezsen 10 saniye içinde komut iptal edilecektir. <a:czcz_dikkat:784731284403519558> **"
              )
          ...
          try {
            ...
            return msg.channel.sendEmbed(
              new Discord.RichEmbed()
                .setColor("#ff0000")
                .setDescription(
                  "**10 saniye boyunca bir şarkı seçmediğiniz için komut iptal edildi. <a:czcz_dikkat:784731284403519558> **."
                )
            );
          }
          ...
          return msg.channel.sendEmbed(
            new Discord.RichEmbed()
              .setColor("0x36393E")
              .setDescription(`**Böyle Bir Şarkı Mevcut Değil Tekrar Dener yada Kontrol Edermisin ?**`)
          );
        }
      }
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!voiceChannel || voiceChannel.type !== "voice")
        return msg.reply(
          "**Ses Kanalında Kimse Olmadığı İçin Çıkış Yaptım <a:mk_zil1:777633388500484096> **"
        );
      voiceChannel
        .join()
      ...
      if (!msg.member.voiceChannel)
        return msg.channel.sendEmbed(
          new Discord.RichEmbed()
            .setColor("RANDOM")
            .setDescription(
              "**Hmm. Sanki Bu Komutu Kullanman İçin Ses Kanalına Girmn Lazım <a:czcz_tavsan:785816868388208660> **"
            )
        );
    if (!serverQueue)
      return msg.channel.sendEmbed(
    ...
    serverQueue.connection.dispatcher.end("**Sıradaki Şarkıya Geçtim!**");
    return undefined;
  } else if (command === "kapat") {
    if (!serverQueue || !serverQueue.playing)
      return msg.channel.send("**Şuanda Şarkı Oynatılmıyor");
    ...
    if (serverQueue && serverQueue.playing) {
      ...
      return msg.channel.sendEmbed(
        new Discord.RichEmbed()
          .setTitle("**Şarkıyı kapattım <a:mk_evet2:780868350975934502> **")
          .setColor("RANDOM")
      );
    }
...
async function handleVideo(video, msg, voiceChannel, playlist = false) {
  ...
  if (!serverQueue) {
    ...
    try {
      ...
      console.error(
        `❎ | **Şarkı Sisteminde Problem Var Hata Nedeni: ${error} Lütfen Destek Sunucmuza Bildir**`
      );
...
Pingim: ${client.ping}`
      ...
      .setImage(
        "https://cdn.discordapp.com/attachments/776349415278772234/787262415346991124/video-game_1f3ae.png"
      )

      .addField("Süre", `${song.durationm}:${song.durations}`, true)
      .setColor("#00ccff")
      .addField("CızCızMüzik+")
  );
}